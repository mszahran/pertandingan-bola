                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <input autocomplete="off" class="form-control @error('nama_klub') is-invalid @enderror" name="nama_klub" type="text" value="{{old('nama_klub')}}" placeholder="Nama Klub" required autofocus>
                                @error('nama_klub')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <input autocomplete="off" class="form-control @error('nama_kota') is-invalid @enderror" name="nama_kota" type="text" value="{{old('nama_kota')}}" placeholder="Nama Kota Klub" required>
                                @error('nama_kota')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
